...
import { fetchAsyncMachineImages, getAllMachinepopup, getMachineSelectedImage } from "../Redux/products/MachinePopupSlice";
import { setMachineShow } from "../Redux/products/MachinePopupSlice";
...
const MachineEnquiryForm = ({ show, pageNo, onHide }) => {
  ...
  const popupmachineimage = useSelector(getAllMachinepopup);
  ...
  console.log("machinepopup", popupmachineimage.result);
  const machineselectedImage = useSelector(getMachineSelectedImage);
  console.log("selectedmachineimage", machineselectedImage);
  ...
  useEffect(() => {
    dispatch(fetchAsyncMachineImages(pageNo))
  }, [pageNo])
 
  let renderpopup = popupmachineimage.result?.map((detail, index) =>(
    machineselectedImage === index ? (
            <Modal size="lg" show={show}>
            <ModalHeader closeButton onClick={() => dispatch(setMachineShow(false))}>
