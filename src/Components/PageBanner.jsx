...
const PageBanner = (props) => {
  ...
  return (
    <>
     <div className={title ==="" ? "page-banner-area1 page-banner-height1" : "page-banner-area page-banner-height"} style={{background: background}} data-background="assets/img/new/p_bg2.jpg">
  <div className="container">
    <div className="row">
      <div className="col-xl-12">
        <div className={`page-banner-content ${title.length > 20 ? "text-start" : "text-center"}`}>
          <h1 className='reshone' style={{color: '#ffffff'}}>{title}</h1>
