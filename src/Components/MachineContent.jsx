            ...
            <div className="widget-category-list mt-20">
              <form action="#">
                <div className="single-widget-category">
                  <label htmlFor="cat-item-1">Turret Punching Machine</label>
                </div>
                <div className="single-widget-category">
                  <label htmlFor="cat-item-2">Bending Machine</label>
                </div>
                <div className="single-widget-category">
                  <label htmlFor="cat-item-3">Shearing Machine</label>
                </div>
                <div className="single-widget-category">
                  <label htmlFor="cat-item-4">Laser Cutting Machine</label>
                </div>
                <div className="single-widget-category">
                  <label htmlFor="cat-item-5">Water Jet Cutting Machine</label>
                </div>
                <div className="single-widget-category">
