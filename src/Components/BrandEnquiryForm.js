...
import { fetchAsyncBrandImages, getAllBrandpopup, getBrandSelectedImage } from "../Redux/products/BrandPopupSlice";
import { setBrandShow } from "../Redux/products/BrandPopupSlice";
...
const BrandEnquiryForm = ({ show, brand, page, pageSize, onHide }) => {
  ...
  const popupbrandimage = useSelector(getAllBrandpopup);
  ...
  console.log("brandpopup", popupbrandimage.result);
  const brandselectedImage = useSelector(getBrandSelectedImage);
  console.log("selectedbrandimage", brandselectedImage);
  ...
  useEffect(() => {
    dispatch(fetchAsyncBrandImages({brand, page, pageSize}))
  }, [brand, page, pageSize])
 
  let renderpopup = popupbrandimage.result?.map((detail, index) =>(
    brandselectedImage === index ? (
            <Modal size="lg" show={show}>
            <ModalHeader closeButton onClick={() => dispatch(setBrandShow(false))}>
